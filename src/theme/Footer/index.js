...
export default function Footer() {
  ...
  function getSocialIcon(label = "") {
    ...
    if (l.includes("linkedin"))
      return { icon: <LinkedInIcon />, glow: "#0077B5" };
    ...
    <FadeInOnScroll direction="up" delay={0}>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, #D05786 0%, #ECDA90 50%, #63C5EA 100%)",
          }}
        />
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
            ...
            <div className="space-y-3">
              <span
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #ECDA90 0%, #B7C3F3 50%, #ECDA90 100%)",
              ...
              <p className="text-gray-500 text-xs">contact@fynesforge.dev</p>
            </div>
